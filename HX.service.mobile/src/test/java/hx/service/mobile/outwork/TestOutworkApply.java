...
//        String url = "http://39.106.226.73:81/mobile/outwork/apply/view";
        String url = "http://localhost:81/mobile/outwork/apply/view";
        OutworkApplyDetailRequest request = new OutworkApplyDetailRequest();
